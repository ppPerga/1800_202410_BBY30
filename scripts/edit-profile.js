...
editForm.addEventListener('submit', function(event) {
    ...
    if (!applyChanges.checked) {
        // Display a message or perform any action indicating that changes are not applied
...
function showSuccessMessage() {
    ...
    // Reload the page after a short delay to ensure the user sees the confirmation message
    setTimeout(function() {
